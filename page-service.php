...
<main>
  <div class="main_container">
    <section class="service_main">
      ...
      <div class="service_img">
        <img class="speak_human" src="<?php echo esc_url(get_theme_file_uri('img/看護師と利用者が対話してる様子 1.png')); ?>" alt="対話の写真">
        <div class="img_photo">
          <img class="photo" src="<?php echo esc_url(get_theme_file_uri('img/MVイメージ画像1 1.png')); ?>" alt="散歩の写真">
          <img class="photo" src="<?php echo esc_url(get_theme_file_uri('img/イメージ画像.png')); ?>" alt="対話の写真">
          <img class="photo" src="<?php echo esc_url(get_theme_file_uri('img/イメージ画像.png')); ?>" alt="対話の写真">
        </div>
      </div>
    </section>
  ...
  <section class="second_content">
    <div class="service_text_space">
      <div class="second_photo">
        <img class="smile_tolk" src="<?php echo esc_url(get_theme_file_uri('img/対話イメージ 1.png')); ?>" alt="対話の写真">
  ...
  <section class="third_content">
    <div class="kanto_power">
      ...
      <div class="power_point">
        ...
        <div class="point2">
          ...
          <div class="point2_img">
            <img class="illustration1" src="<?php echo esc_url(get_theme_file_uri('img/KANTOイメージ 1.png')); ?>" alt="寄り添う写真">
      ...
      <div class="last_space">
        ...
        <p> 「家での暮らしが不安」<span class="pc_space"> </span><br class="sp_only">「一人での生活がむずかしい」<br>そんなときは、グループホーム「SETA」という選択肢もご一緒に検討できます。</p>
      </div>
    </div>
  </section>
  ...
  <section class="forth_content">
    <div class="step">
      ...
      <img class="nurse" src="<?php echo esc_url(get_theme_file_uri('img/ご利用までの流れイメージ写真 1.png')); ?>" alt="看護師">
    </div>
  </section>
