    ...
    <div class="staff-main">
        ...
        <div class="card" id="staff1">
            ...
            <div class="status">
                ...
                <div class="staff-concept">
                    <p><span class="sub-title">趣味：</span>バイクでキャンプ/パン作り</p>
                </div>
                <div class="staff-concept">
                    <p><span class="sub-title">座右の銘：</span>七転び八起き</p>
                </div>
        ...
        <div class="card" id="staff2">
            <div class="status">
                ...
                <div class="staff-concept">
                    <p><span class="sub-title">趣味：</span>スポーツ/歌やギター/ゲーム</p>
                </div>
                <div class="staff-concept">
                    <p><span class="sub-title">座右の銘：</span>プロテイン</p>
                </div>
        ...
        <div class="card" id="staff3">
            ...
            <div class="status">
                ...
                <div class="staff-concept">
                    <p><span class="sub-title">趣味：</span>ごはん</p>
                </div>
                <div class="staff-concept">
                    <p><span class="sub-title">座右の銘：</span>早寝早起き</p>
                </div>
